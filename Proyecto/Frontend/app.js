        ...
        <tr data-id="${item.id_baul}">
            ...
            <td>
                <button type="button" class="btn btn-info"
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/512/6335/6335643.png" height="30" width="30"/>
                </button>
                <button type="button" class="btn btn-warning"
                    onclick="eliminar(${item.id_baul})">
                    <img src="https://cdn-icons-png.flaticon.com/512/5676/5676146.png" height="30" width="30"/>
                </button>
            </td>
        </tr>
        `;
